...
# this variant 22.06.2019
#
# forked 22.06.2019 from quiner.awk variant  09.05.2015
#
# not in repo: https://github.com/chorasimilarity/chemlambda-gui/tree/gh-pages/dynamic
#
# called by quiner-mod.sh, reads a .mol file and applies a random reduction algorithm, (with the BB TM nodes  and moves added).
#
# modified A-FO rewrite, gives 2 FO and 2 A
#
...
########  if afosameafoe=1 then A-FO and A-FOE are the same (produce 2 FOE nodes), else A-FO produces 2 FO nodes instead   
...
######## if you want to eliminate (i.e. make it very improbable) a rewrite then pick a big wei_*
...
# FO or FOE?
                                  ...
                                  depends = all_node_atom[targe];
                                  if (depends=="FOE") {coldepends=in_col;} else {coldepends=green_col;}


#definition of FO/FOE node and edges, internal and external, in proposed_add
...
# FO or FOE?
                                  ...
                                  depends = all_node_atom[targe];
                                  if (afosameafoe==1) {depends="FOE"; coldepends=in_col;} else {
                                  if (depends=="FOE") {coldepends=in_col;} else {coldepends=green_col;}}
...
#definition of FO/FOE node and edges, internal and external, in proposed_add
                                  ...
                                  proposed_all_node_atom[junu]=depends;
                                  proposed_all_node_size[junu]=main_const;
                                  proposed_all_node_colour[junu]=coldepends;
                                  proposed_all_node_id[junu]=junu;
...
#definition of FO/FOE node and edges, internal and external


                                  proposed_all_node_atom[jdoi]=depends;
                                  proposed_all_node_size[jdoi]=main_const;
                                  proposed_all_node_colour[jdoi]=coldepends;
                                  proposed_all_node_id[jdoi]=jdoi;
